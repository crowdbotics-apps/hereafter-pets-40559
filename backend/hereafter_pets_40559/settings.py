"""
Django settings for hereafter_pets_40559 project.
...
ROOT_URLCONF = 'hereafter_pets_40559.urls'
...
WSGI_APPLICATION = 'hereafter_pets_40559.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hereafter_pets_40559 API",
    "DESCRIPTION": "API documentation for hereafter_pets_40559 App",
    "VERSION": "v1",
}
